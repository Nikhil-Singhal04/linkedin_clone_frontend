    ...
    <NavLink to="/profile">
      ...
      <div className="mt-6">
        <ul className="text-2xl font-semibold flex flex-col gap-3">
          ...
          <li className="cursor-pointer flex items-center gap-2"> <div><IoIosSettings /></div>
          <div>Account settings</div></li>
          <li className="cursor-pointer flex items-center gap-2"><div><TbPremiumRights /></div>Upgrade to Premium</li>
        </ul>
      </div>
    </div>
  );
